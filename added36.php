...
<div id=ce2>
 <div id="ap"><img src="素材/上架3.png" width="978" height="557" alt="上架3-1" />
   <div id="apDiv">
<FORM name="form1" action="added_06.php?id=<?PHP echo $_GET['id'];?>&gender=<?PHP echo $_GET['gender'];?>&s_number=<?PHP echo $_GET['s_number'];?>" method="post" enctype="multipart/form-data" >
<?PHP

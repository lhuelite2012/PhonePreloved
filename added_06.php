	 ...
	 if (($_FILES["c_mp"]["type"] == "image/gif") || ($_FILES["c_mp"]["type"] == "image/jpeg")||($_FILES["c_mp"]["type"] == "image/jpg")||($_FILES["c_mp"]["tmp_name"]=="image/png")||($_FILES["pop"]["tmp_name"]==""))//限定檔案gif jpg png
	  ...
	  if (move_uploaded_file($tmpfile,$picturePathWeb.$m_number."_".$name))//上傳檔案
	   ...
	   $hi_bid_price = $_POST['c_price'];
		$sql_query ="INSERT into  commodity(b_number,c_gender,s_number,c_name,location,oan,c_price,c_date,c_height,c_shoulder,size,s_size,UDHeight,LRLength,bWidth,MWidth,SLongest,colors_number,material,c_mp,c_movie,pop,m_number,hi_bid_price)
		VALUES(
	'$b_number',
	'$c_gender',
	'$s_number',

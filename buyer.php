...
<?PHP		
	...
	//查詢賣家是否為使用者
	$sql_om = "select * from commodity where orbidder != '' and m_number = '$m_number'";
	$query_om = mysql_query($sql_om);
	
	//查詢買家評價筆數
	$row = mysql_num_rows($query_om);
?>
...
<div align="center" id="apDiv63">
    ...
    <font size="5" color="#0000FF"><strong>買家評價 共 <?PHP echo $row;?> 筆</strong></font><p></p>
    <hr width="500" size="1" /><p></p>
<?PHP
	while($list3_om = mysql_fetch_row($query_om))
	{
		...
		//查詢評價分數及原因
		$sql_f = "select f_record_.*,fraction_.* from fraction_ join f_record_ on f_record_.fr_number = fraction_.fr_number where (f_record_.m_number = '$buy' and f_record_.c_number = '$c_number' and fraction_.fraction_type = '2') or (f_record_.m_number = '0' and f_record_.c_number = '$c_number')";
...
<form action="" method="post" name="form">
	<table align="center" width="500">
        ...
        <tr>
			...
			<?PHP
			if($list3_f[0] != '' and $list3_f[0] != '0') echo 評價人：買家;
			if($list3_f[0] == '') echo 買家目前還沒給賣家評價分數;

...
<?		
	...
	//查詢賣家是否為使用者
	$sql_om = "select * from commodity where orbidder != '' and m_number = '$u'";
...
<div align="center" id="apDiv63">
    ...
    <font size="5" color="#0000FF"><strong>買家評價 共 <? echo $row;?> 筆</strong></font><p></p>
    <hr width="500" size="1" /><p></p>
<?
	while($list3_om = mysql_fetch_row($query_om))
	{
		...
		//查詢評價分數及原因
		$sql_f_ = "select f_record_.*,fraction_.* from fraction_ join f_record_ on f_record_.fr_number = fraction_.fr_number where f_record_.c_number = '$c_number' and f_record_.m_number = '$buy' and fraction_.fraction_type = '2'";

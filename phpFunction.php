...
//-------------------------------------------------------------------------	
//通知
	function push($p_type,$addtime,$c_number,$push_who,$push_what){
		$push_sql = "insert into push(p_type,p_time,c_number,push_m_number,bid_number) values ('$p_type','$addtime','$c_number','$push_who','$push_what')";

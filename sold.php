...
<div align="center" id="apDiv61">
    ...
    <font size="5" color="#0000FF"><strong>已賣出 共 <? echo $row;?> 筆</strong></font><p></p>
    <hr width="500" size="1" /><p></p>
<?	
	...
	<table align="center" width="500">
        ...
        <tr>
            ...
            <?
				...
				{
			?>
                    <a href="transaction_check.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/未對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/未寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/未評價.png"></a>
			<?
				}
			...
			<?
				...
				{
			?>
   					<a href="transaction_check.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/已對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/未寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/未評價.png"></a>
			<?
				}
			...
			?>
    				<a href="transaction_check.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/已對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/已寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/未評價.png"></a>
			<?
				}
			...
			?>
   					<a href="transaction_check.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/已對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/已寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<? echo $list3_c[0]; ?>"><img src="素材/已評價.png"></a>
			<?
				}

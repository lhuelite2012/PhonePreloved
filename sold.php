...
<?PHP
	...
	//查詢商品名稱為已賣出
	$m_number = $list3[0];
	$sql_c = "select * from commodity where m_number = '$m_number' and orsell = '1' and orend = '1'";
...
<div align="center" id="apDiv61">
    ...
    <font size="5" color="#0000FF"><strong>已賣出 共 <?PHP echo $row;?> 筆</strong></font><p></p>
    <hr width="500" size="1" /><p></p>
<?PHP	
...
<form action="" method="post" name="form">
	<table align="center" width="500">
		...
		<?PHP if($list3_c_[1] != "交易完成" && $list3_c_[1] != "交易失敗") { ?><div id="t"><a href="transaction_sellno.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/交易失敗.png" width="19" height="22" title="提出交易失敗"></a></div><?PHP }?>
        <tr>
        ...
        <tr>
            ...
            <?PHP
				...
				{
			?>
                    <a href="transaction_check.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未評價.png"></a>
			<?PHP
				}
				else if($list3_c_[1] == "已付款" and $list3_c_[11] != '1')
				{
			?>
   					<a href="transaction_check.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未寄出.png"></a>
			...
			<?PHP
				...
				{
			?>
   					<a href="transaction_check.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/已對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未評價.png"></a>
			<?PHP
				}
				else if($list3_c_[1] == "已寄出")
				{
			?>
    				<a href="transaction_check.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/已對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/已寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/未評價.png"></a>
			<?PHP
				}
				else if($list3_c_[1] == "選擇評價")
				{
			...
			?>
   					<a href="transaction_check.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/已對帳.png"></a>
                    <a href="transaction_sellsend.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/已寄出.png"></a>
                    <a href="transaction_sellevaluate.php?c_number=<?PHP echo $list3_c[0]; ?>"><img src="素材/已評價.png"></a>
			<?PHP
					}
					else
					{

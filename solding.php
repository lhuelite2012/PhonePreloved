...
<div align="center" id="apDiv61">
    ...
    <font size="5" color="#0000FF"><strong>販賣中 共 <? echo $row;?> 筆</strong></font><p></p>
    <hr width="500" size="1" /><p></p>
<?	
...
<form action="" method="post" name="form">
	<table align="center" width="500">
        ...
        <tr>
        	<td><label><font size="3" color="#8080C5"><strong>最高出價者：<? if($list3_bm[5] != ""){echo $list3_bm[5];}else{echo 目前沒有最高出價者;}?></strong></font></label></td>
		</tr>
        <tr>

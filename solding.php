...
<?PHP	
	...
	//查詢商品名稱為未賣出
	$m_number = $list3[0];
	$sql_c = "select * from commodity where m_number = '$m_number' and orsell = '0' and orend = '0'";
...
<div align="center" id="apDiv61">
    ...
    <font size="5" color="#0000FF"><strong>販賣中 共 <?PHP echo $row;?> 筆</strong></font><p></p>
    <hr width="500" size="1" /><p></p>
<?PHP	
	while($list3_c = mysql_fetch_row($query_c))
	{
		...
		//查詢商品出價最高得標者
		$sql_bm = "select bid.*,members.name,commodity.hi_bid_price from bid join members  join commodity on commodity.orsell = '0' and bid.bid_price = commodity.hi_bid_price and bid.m_number = members.m_number where bid.c_number = '$c_number'";
...
<form action="" method="post" name="form">
	<table align="center" width="500">
		...
		<tr>
			<td><label><font size="3" color="#8080C5"><strong>最高出價：<?PHP if($list3_c[2] != "0"){echo $list3_c[2];?> 元<?PHP }else{echo 目前並沒有下標出價;}?></strong></font></label></td>
		</tr>
        <tr>
        	<td><label><font size="3" color="#8080C5"><strong>最高出價者：<?PHP if($list3_bm[5] != ""){echo $list3_bm[5];}else{echo 目前沒有最高出價者;}?></strong></font></label></td>
		</tr>
        <tr>
